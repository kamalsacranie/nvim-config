...
M.on_attach = function(client, bufnr)
	...
	if client.resolved_capabilities.document_highlight then
		...
		vim.cmd([[hi LspReferenceRead cterm=bold gui=bold ctermbg=red guibg=#353d46]])
		vim.cmd([[hi LspReferenceText cterm=bold gui=bold ctermbg=red guibg=#353d46]])
		vim.cmd([[hi LspReferenceWrite cterm=bold gui=bold ctermbg=red guibg=#353d46]])
